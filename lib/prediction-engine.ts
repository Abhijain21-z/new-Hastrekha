...
export function generatePrediction(
  ...
  if (lang === "hi") {
    ...
    return {
      personality: `आप ${sign} राशि के हैं, जो ${element} तत्व से संबंधित है। आप स्वभाव से दयालु, समझदार और गहरी सोच रखने वाले व्यक्ति हैं। आप किसी भी स्थिति को सिर्फ ऊपर से नहीं देखते, बल्कि उसकी गहराई को समझते हैं। लोग आपको मजबूत मानते हैं, लेकिन आपका दिल बहुत संवेदनशील है। आप दूसरों की मदद करने में विश्वास रखते हैं, लेकिन कई बार ऐसा महसूस करते हैं कि आपकी अच्छाई का फायदा उठाया जाता है। आप अपनी भावनाएँ आसानी से व्यक्त नहीं करते, इसलिए लोग आपकी असली सोच समझ नहीं पाते। आपके अंदर नेतृत्व क्षमता है, पर आत्मविश्वास कभी-कभी परिस्थितियों के कारण कम हो जाता है।`,
      qualities: {
        strengths: [
      ...
      education: `आप बुद्धिमान हैं, लेकिन ध्यान भटकने की वजह से पढ़ाई में उतना परिणाम नहीं मिला जितना मिल सकता था। प्रैक्टिकल ज्ञान और अनुभव आपकी असली ताकत हैं। ${element} तत्व के प्रभाव से तकनीकी, विज्ञान, या कला से संबंधित क्षेत्रों में विशेष रुचि है।`,
      challengeAges: [
      ...
      spiritual: `आपके अंदर आध्यात्मिक ऊर्जा है। मंदिर, ध्यान, या प्रकृति के पास जाने से मन शांत होता है। ${sign} राशि पर ग्रहीय प्रभाव: आपके जन्म समय ग्रहों की स्थिति आपके जीवन में शुभ प्रभाव डालती है। शनि और बृहस्पति की दशा पर विशेष ध्यान दें।`,
      lucky: {
      ...
      remedies: [
        ...
        "रोज़ 5 मिनट ध्यान या प्राणायाम करें",
      ],
    };
  }
  ...
  return {
    ...
    education: `You are intelligent, but due to distractions, you didn't get as much result in studies as you could have. Practical knowledge and experience are your real strengths. Under the influence of the ${element} element, there is special interest in technology, science, or arts-related fields.`,
    challengeAges: [
    ...
    spiritual: `You have spiritual energy within you. Visiting temples, meditation, or being close to nature calms the mind. Planetary influence for ${sign}: The position of celestial bodies at your birth time casts positive influence on your life. Pay special attention to Saturn and Jupiter transits.`,
    lucky: {
      numbers: `${luckyNum1}, ${luckyNum2}, ${luckyNum3}`,
      color: pick(colors, rng),
      day: pick(days, rng),
