    ...
    <section className="relative overflow-hidden py-16 lg:py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="mb-10 flex items-center justify-center gap-8 lg:gap-16">
          <div className="relative h-24 w-24 overflow-hidden rounded-full border-2 border-primary/30 shadow-lg animate-glow-ring lg:h-32 lg:w-32">
            <Image
              src="/images/ganesh-ji.jpg"
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative">
              ...
              <PalmSVG className="relative h-80 w-64 animate-float lg:h-96 lg:w-80" />

              {/* Floating cards */}
              <div className="absolute -left-8 top-8 animate-float rounded-xl border border-primary/20 bg-card/95 px-4 py-3 shadow-lg backdrop-blur-sm border-glow" style={{ animationDelay: "0.5s" }}>
              ...
              <div className="absolute -right-4 bottom-20 animate-float rounded-xl border border-primary/20 bg-card/95 px-4 py-3 shadow-lg backdrop-blur-sm border-glow" style={{ animationDelay: "1s" }}>
                <div className="flex items-center gap-2">
