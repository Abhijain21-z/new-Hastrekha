...
export function ReportView({
  ...
  const r = language === "hi" ? reportHi : report;
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-lg border border-green-200 bg-green-50/50 p-4">
              <h4 className="mb-2 flex items-center gap-1.5 text-sm font-semibold text-green-700">
                ...
                {language === "hi" ? "प्रमुख गुण" : "Key Strengths"}
              </h4>
              <ul className="flex flex-col gap-1.5">
                {r.qualities.strengths.map((s, i) => (
                  <li
                    key={i}
            ...
            <div className="rounded-lg border border-amber-200 bg-amber-50/50 p-4">
              <h4 className="mb-2 flex items-center gap-1.5 text-sm font-semibold text-amber-700">
                ...
                {language === "hi" ? "संभावित दोष" : "Possible Weaknesses"}
              </h4>
              <ul className="flex flex-col gap-1.5">
                {r.qualities.weaknesses.map((w, i) => (
                  <li
                    key={i}
        ...
        >
          <div className="grid grid-cols-3 gap-3">
            <div className="rounded-lg border border-primary/15 bg-primary/5 p-4 text-center">
              ...
              <div className="mt-1 text-xs text-muted-foreground">
                {language === "hi" ? "शुभ अंक" : "Lucky Numbers"}
              </div>
            </div>
            <div className="rounded-lg border border-primary/15 bg-primary/5 p-4 text-center">
              <div className="font-serif text-xl font-bold text-primary">
