    ...
    <PageShell>
      <article className="mx-auto max-w-3xl px-4 py-16 lg:px-8 lg:py-24">
        ...
        <div className="prose-editorial mt-10 space-y-8 text-muted-foreground">
          ...
          <section><h2>Cookies and choices</h2><p>Essential browser storage may remember your language preference. Optional analytics or advertising cookies can be controlled through your browser and, where available, the provider’s controls. See our <Link href="/cookies" className="text-primary underline">Cookie Policy</Link>.</p></section>
