...
const blogPosts = [
  {
    ...
    excerptEn:
      'Master the ancient sciences of palmistry and astrology. Learn about the five major palm lines, mounts, astrological connections, and how to read your own palm.',
    excerptHi:
      'हस्तरेखा विज्ञान और ज्योतिष में महारत हासिल करें। पांच प्रमुख हथेली रेखाओं, माउंटों, ज्योतिषीय संबंधों और अपनी हथेली को पढ़ने के बारे में जानें।',
...
Get comprehensive palm reading and astrological analysis at HastRekhaAi.`,
...
आपकी हथेली पर सात माउंट, जिनमें से प्रत्येक विभिन्न ग्रहीय प्रभावों का प्रतिनिधित्व करता है, आपके चरित्र और संभावना में अतिरिक्त अंतर्दृष्टि प्रदान करते हैं।`,
    date: 'Mar 10, 2026',
...
ग्रहीय अवधियां (दशाएं) जीवन क��� प्रमुख घटनाओं की भविष्यवाणी करती हैं। शनि की ढैया (साढ़े साती) परिवर्तन की विशेष अवधि है।

<a href="https://hastrrekhaai.com" style="color: #D4A574; text-decoration: underline;">HastRekhaAi पर</a> अपना मुक्त वैदिक ज्योतिष विश्लेषण प्राप्त करें और अपने ब्रह्��ांडीय ब्लूप्रिंट की खोज करें।`,
    date: 'Feb 5, 2026',
...
<a href="https://hastrrekhaai.com" style="color: #D4A574; text-decoration: underline;">HastRekhaAi पर</a> हम Gemini की उन्नत छवि पहचान को सदियों के वैदिक हस्तरेखा ज्ञान के साथ जोड़ते हैं। प्रत्येक रीडिंग व्यापक अंतर्दृष्टि के लिए ग्रहीय स्थिति, संख्या विज्ञान, और हस्तरेखा विश्लेषण पर विचार करती है।`,
  ...
  },
  {
    ...
    excerptHi:
      '�����ानिए कि ग्रहों की स्थिति और हस्तरेखाएं विवाह के समय, साथी की अनुकूलता को कैसे दर्शाती हैं।',
...
मध्यकाल के दौरान, हिंदू, मुस्लिम, और बौद्ध विद्वानों ने इस विज्ञान को संरक्षित और उन्नत किया, जो इसकी गहरी अंतर्दृष्टि को पहच���नते थे।
...
आधुनिक भारत में, हस्तरेखा विज्ञान वैदिक ज्योतिष और आध्यात्मिक अभ्यास के साथ गहराई से एकीकृत है। <a href="https://hastrrekhaai.com" style="color: #D4A574; text-decoration: underline;">HastRekhaAi पर</a> इस प्राचीन विज्ञान के ज्ञान की खोज करें।`,
  ...
  },
  {
    ...
    excerptEn: 'Learn about the rare and powerful triangle mark on the palm and what it reveals about your spiritual gifts and destiny.',
    excerptHi: 'हथेली पर दुर्लभ और शक्तिशाली त्रिकोण निशान के बारे में जानें और यह आपकी आध्यात्मिक शक्तियों के बारे में क्या बताता है।',
    ...
    contentHi: `हस्तरेखा विज्ञान में, तीन प्रमुख रेखाओं के संगम से बना त्रिकोण सबसे शुभ चिन्हों में से एक माना जाता है। यह दुर्लभ प्रतीक उच्च अंतर्ज्ञान, आध्यात्मिक जागरूकता और असाधारण समस्या-समाधान क्षमता को दर्शाता है। हथेली पर त्रिकोण निशान वाले लोग अक्सर प्राकृतिक उपचार क्षमता रखते हैं।`,
    date: 'Mar 5, 2026',
    readTime: '6 min read',
    category: 'Palmistry',
  },
  {
    ...
    excerptEn: 'Discover the rare and powerful M pattern formed naturally on the palm and its connection to fortune, success, and spiritual destiny.',
    excerptHi: 'हथेली पर प्राकृतिक रूप से बने दुर्लभ M पैटर्न की खोज करें और भाग्य, सफलता और आध्यात्मिक भाग्य के साथ इसके संबंध को जानें।',
    ...
    contentHi: `हथेली पर कई रेखाओं के संगम से प्राकृतिक रूप से बना अक्षर M एक असाधारण दुर्लभ और शक्तिशाली निशान है। अपनी हथेली पर M वाले लोगों में असाधारण भाग्य, व्यावसायिक कौशल और नेतृत्व गुण होने माने जाते हैं। यह निशान सफलता और मान्यता के लिए नियत व्यक्ति को दर्शाता है।`,
    date: 'Mar 3, 2026',
    readTime: '5 min read',
    category: 'Palmistry',
  },
  {
    ...
    excerptEn: 'Understand the significance of a split or forked life line and what it reveals about life changes and major transitions.',
    excerptHi: 'विभाजित या कांटेदार जीवन रेखा का महत्व समझें और यह जीवन के बदलावों के बारे में क्या बताता है।',
    ...
    contentHi: `हस्तरेखा विज्ञान में विभाजित जीवन रेखा जीवन में महत्वपूर्ण परिवर्तन और नई दिशा को दर्शाती है। यह विभाजित रेखा कठिनाई नहीं बल्कि कई जीवन मार्ग और विकास के अवसर का सुझाव देती है। यह निशान अक्सर प्रमुख निर्णयों या परिवर्तनों से पहले दिखाई देता है।`,
    date: 'Feb 28, 2026',
    readTime: '6 min read',
    category: 'Palmistry',
  },
  {
    ...
    excerptEn: 'Learn about the rare and auspicious fish mark on the palm and its meaning in ancient palmistry traditions.',
    excerptHi: 'हथेली पर दुर्लभ और शुभ मछली के निशान के बारे में जानें और प्राचीन हस्तरेखा परंपराओं में इसके अर्थ को समझें।',
    ...
    contentHi: `हथेली पर दिखाई देने वाला मछली का प्रतीक (मत्स्य मुद्रा) वैदिक हस्तरेखा में सबसे शुभ निशानों में से एक है। यह दुर्लभ निशान महान भाग्य, आध्यात्मिक जागरण और दिव्य सुरक्षा के आशीर्वाद को दर्शाता है। हिंदू परंपरा में, मछली का प्रतीक पवित्र है और भगवान विष्णु का प्रतिनिधित्व करता है।`,
    date: 'Feb 25, 2026',
    readTime: '7 min read',
    category: 'Palmistry',
  },
  {
    ...
    excerptEn: 'Discover what circular and ring-shaped marks on your palm reveal about your destiny and life circumstances.',
    excerptHi: 'अपनी हथेली पर गोलाकार और वलय के आकार के निशान आपके भाग्य के बारे में क्या बताते हैं यह जानें।',
    ...
    contentHi: `हथेली पर वृत्त के निशान उनके स्थान के आधार पर विभिन्न अर्थ रखते हैं। जीवन रेखा पर वृत्त चुनौतीपूर्ण अवधियों को दर्शाते हैं। हृदय रेखा पर, वे भावनात्मक तीव्रता का सुझाव देते हैं। ये निशान नकारात्मक नहीं हैं बल्कि व्यक्तिगत ध्यान की आवश्यकता वाले क्षेत्रों को दर्शाते हैं।`,
    date: 'Feb 22, 2026',
    readTime: '6 min read',
    category: 'Palmistry',
  },
  {
    ...
    excerptEn: 'Understand what a straight heart line reveals about your emotional nature, relationships, and love patterns.',
    excerptHi: 'समझें कि सीधी हृदय रेखा आपकी भावनात्मक प्रकृति, संबंधों और प्रेम पैटर्न के बारे में क्या बताती है।',
    ...
    contentHi: `हथेली के आर-पार क्षैतिज रूप से चलने वाली सीधी हृदय रेखा भावनात्मक स्थिरता और संबंधों में व्यावहारिकता को दर्शाती है। सीधी हृदय रेखा वाले लोग प्रेम मामलों में तार्किक होते हैं और स्थिर, प्रतिबद्ध संबंध चाहते हैं। वे विश्वसनीय साथी होते हैं जो भावनाओं को तर्कसंगत रूप से संभालते हैं।`,
    date: 'Feb 20, 2026',
    readTime: '5 min read',
    category: 'Palmistry',
  },
  {
    ...
    excerptEn: 'Explore how a curved head line indicates creative thinking, imagination, and unconventional problem-solving abilities.',
    excerptHi: 'घुमावदार सिर की रेखा कैसे रचनात्मक सोच, कल्पना और अपरंपरागत समस्या समाधान क्षमता को दर्शाती है यह जानें।',
    ...
    contentHi: `एक घुमावदार या झुकी हुई सिर की रेखा रचनात्मक, अंतर्ज्ञानी दिमाग के साथ मजबूत कल्पनाशील क्षमताओं का सुझाव देती है। घुमावदार सिर की रेखा वाले लोग अक्सर कलाकार, नवप्रवर्तक और दूरदर्शी विचारक होते हैं। वे समस्याओं के लिए रचनात्मक दृष्टिकोण रखते हैं।`,
    date: 'Feb 18, 2026',
    readTime: '6 min read',
    category: 'Palmistry',
  },
  {
    ...
    excerptEn: 'What does it mean if you don\'t have a fate line? Discover how to interpret absence and its meaning for your life path.',
    excerptHi: 'यदि आपके पास भाग्य रेखा नहीं है तो इसका क्या मतलब है? इसकी अनुपस्थिति और आपके जीवन पथ के लिए इसके अर्थ को समझें।',
    ...
    contentHi: `भाग्य रेखा की अनुपस्थिति भाग्य की कमी नहीं बल्कि स्वतंत्रता और व्यक्तिगत विकल्प को दर्शाती है। स्पष्ट भाग्य रेखा के बिना लोगों को पूर्वनिर्धारित रास्तों के बिना अपना भाग्य बनाने की शक्ति होती है। वे आत्मनिर्भर, स्वतंत्र और साहसिक जीवन विकल्प करने में सक्षम होते हैं।`,
    date: 'Feb 15, 2026',
    readTime: '7 min read',
    category: 'Palmistry',
  },
  {
    ...
    excerptEn: 'Learn how a prominent sun line indicates talent, creativity, and the potential for achieving fame and success in your chosen field.',
    excerptHi: 'समझें कि कैसे एक प्रमुख सूर्य रेखा प्रतिभा, रचनात्मकता और अपने क्षेत्र में प्रसिद्धि और सफलता प्राप्त करने की संभावना को दर्शाती है।',
    ...
    contentHi: `हथेली के आधार से अनामिका तक चलने वाली एक मजबूत, स्पष्ट सूर्य रेखा हस्तरेखा में सबसे शुभ निशानों में से एक है। यह प्राकृतिक प्रतिभा, करिश्मा और सार्वजनिक मान्यता प्राप्त करने की संभावना को दर्शाती है। मजबूत सूर्य रेखा वाले लोग रचनात्मक और अभिव्यक्तिमय होते हैं।`,
    date: 'Feb 12, 2026',
    readTime: '7 min read',
    category: 'Palmistry',
  },
  {
    ...
    excerptEn: 'Explore the meaning of multiple marriage lines and what it reveals about your romantic future and relationship patterns.',
    excerptHi: 'कई विवाह रेखाओं के अर्थ की खोज करें और यह आपके रोमांटिक भविष्य और संबंध पैटर्न के बारे में क्या बताता है।',
    ...
    contentHi: `हथेली पर कई विवाह रेखाएं जरूरी नहीं कि कई विवाह को दर्शाती हैं बल्कि महत्वपूर्ण संबंध और महत्वपूर्ण जीवन अध्यायों को दर्शाती हैं। ये रेखाएं गहरे भावनात्मक बंधन, साझेदारी और जीवन के प्रमुख मार्कों का प्रतिनिधित्व कर सकती हैं।`,
    date: 'Feb 10, 2026',
    readTime: '6 min read',
    category: 'Palmistry',
  },
  {
    ...
    excerptEn: 'Understand what a grid or lattice pattern on your palm reveals about obstacles, challenges, and spiritual evolution.',
    excerptHi: 'समझें कि आपकी हथेली पर एक जाली या जाली पैटर्न बाधाओं, चुनौतियों और आध्यात्मिक विकास के बारे में क्या बताता है।',
    ...
    contentHi: `हथेली पर दिखाई देने वाला जाली या जाली पैटर्न चुनौती और आध्यात्मिक विकास की अवधि को दर्शाता है। यह पैटर्न नकारात्मक नहीं है बल्कि बाधाओं को विकास के अवसरों के रूप में दर्शाता है। जाली पैटर्न वाले लोग लचीले होते हैं।`,
    date: 'Feb 8, 2026',
    readTime: '5 min read',
    category: 'Palmistry',
  },
  {
    ...
    excerptEn: 'Discover the financial indicators in palmistry and astrology that predict wealth, prosperity, and financial success.',
    excerptHi: 'हस्तरेखा और ज्योतिष में वित्तीय संकेतकों की खोज करें जो धन, समृद्धि और वित्तीय सफलता की भविष्यवाणी करते हैं।',
    ...
    contentHi: `विभिन्न हथेली के निशान और ज्योतिषीय संकेतक वित्तीय समृद���धि का सुझाव देते हैं। बृहस्पति की उंगली (तर्जनी) प्रचुरता का प्रतिनिधित्व करती है, जबकि धन रेखाएं आर्थिक क्षमता को दर्शाती हैं। ज्योतिष में, बृहस्पति की स्थिति 2, 8 और 11 वें घर वित्त को नियंत्रित करते हैं।`,
    date: 'Feb 5, 2026',
    readTime: '8 min read',
    category: 'Guidance',
  },
  {
    ...
    excerptEn: 'Learn the ancient criteria for identifying naturally lucky hands according to Samudrika Shastra and what combinations bring fortune.',
    excerptHi: 'समुद्रिक शास्त्र के अनुसार स्वाभाविक रूप से भाग्यशाली हाथों की पहचान के लिए प्राचीन मानदंड जानें।',
    ...
    contentHi: `समुद्रिक शास्त्र के अनुसार, कुछ हाथ की विशेषताओं को स्वाभाविक रूप से भाग्यशाली माना जाता है। इनमें अच्छी तरह से आनुपातिक उंगलियां, एक मजबूत जीवन रेखा, स्पष्ट हृदय और सिर की रेखाएं, और मछली के प्रतीक या त्रिकोण जैसे शुभ निशान शामिल हैं।`,
    date: 'Jan 28, 2026',
    readTime: '9 min read',
    category: 'Palmistry',
  },
...
export default function BlogPage() {
  return (
    <PageShell>
      <BlogContent blogPosts={blogPosts} categoryColors={categoryColors} />
    </PageShell>
  );
}
